...
public class DefaultUserService implements UserService {
	...
	public void addToProductsRequestedByUser(Long userId, Long productId) {
		...
		if (user.getProductsRequestedByUser().isEmpty()) {
			List<Product> productsRequestedByUserList = new ArrayList<>();
			user.setProductsRequestedByUser(productsRequestedByUserList);
			user.getProductsRequestedByUser().add(product);
	...
	public void deleteProductsRequestedByUser(Long userId, Long productId) {
		...
		if (user.getProductsRequestedByUser().isEmpty()) {
			...
			user.getProductsRequestedByUser().remove(product);
		}

	}

	// Just Displays - No Scope for void references - Delete From Products Posted
